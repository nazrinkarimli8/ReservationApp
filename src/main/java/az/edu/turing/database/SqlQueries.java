...
public class SqlQueries {
    ...
    public static final String updateFlightsQuery = "UPDATE flight SET free_seats = free_seats - (SELECT COUNT(*) FROM bookings_passengers WHERE booking_id = ?) WHERE id = ?;";
    ...
    public static final String createFlightQuery = "INSERT INTO flight (origin, destination, departure_time, free_seats) VALUES (?, ?, ?, ?)";
    public static final String deleteFlightQuery = "DELETE FROM flight WHERE id = ?;";
    public static final String findAllFlightQuery = "SELECT * FROM flights;";
    public static final String findFlightByOriginQuery = "SELECT * FROM flight WHERE origin = ?;";
